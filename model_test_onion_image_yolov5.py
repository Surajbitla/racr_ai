...
weight_path = 'C:/Users/natsu/OneDrive/Documents/Rowan/Work/Encode_Decode/Summer/Paolo/Yolov5/yolov5/runs/train/exp6/weights/best.pt'
...
# Ensure the result has the correct shape (4D: [batch_size, channels, height, width])
if res.dim() == 3:
    res = res.unsqueeze(0)  # Add batch dimension if missing

print(f"Shape of intermediate output: {res.shape}")
